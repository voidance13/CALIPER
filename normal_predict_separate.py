...
def normal_predict(dataset, use_best_hit=False, model_name="Qwen2.5-7B", embed_model="BAAI/bge-base-en-v1.5", rerank_model="BAAI/bge-reranker-large"):
    ...
    if use_best_hit and model_name == "Qwen2.5-7B":
        with open(f"data/{dataset}/normal_7b_sep_pred_use_best_hit.json","w") as f:
            json.dump(answers, f, indent=4)
    elif use_best_hit and model_name == "Qwen2.5-7B-ft":
        with open(f"data/{dataset}/normal_7bft_sep_pred_use_best_hit.json","w") as f:
            json.dump(answers, f, indent=4)
    elif use_best_hit and model_name == "Qwen2.5-0.5B":
        with open(f"data/{dataset}/normal_05b_sep_pred_use_best_hit.json","w") as f:
            json.dump(answers, f, indent=4)
    elif use_best_hit and model_name == "Qwen2.5-0.5B-ft":
        with open(f"data/{dataset}/normal_05bft_sep_pred_use_best_hit.json","w") as f:
            json.dump(answers, f, indent=4)
    elif use_best_hit == False and model_name == "Qwen2.5-7B":
        with open(f"data/{dataset}/normal_7b_sep_pred.json","w") as f:
            json.dump(answers, f, indent=4)
    elif use_best_hit == False and model_name == "Qwen2.5-7B-ft":
        with open(f"data/{dataset}/normal_7bft_sep_pred.json","w") as f:
            json.dump(answers, f, indent=4)
    elif use_best_hit and model_name == "Qwen2.5-72B":
        with open(f"data/{dataset}/normal_72b_sep_pred_use_best_hit.json","w") as f:
            json.dump(answers, f, indent=4)
    elif use_best_hit == False and model_name == "Qwen2.5-72B":
        with open(f"data/{dataset}/normal_72b_sep_pred.json","w") as f:
            json.dump(answers, f, indent=4)

    eval_res = evaluate(answers)

    if use_best_hit and model_name == "Qwen2.5-7B":
        with open(f"data/{dataset}/eval_normal_7b_sep_pred_use_best_hit.json","w") as f:
            json.dump(eval_res, f, indent=4)
    elif use_best_hit and model_name == "Qwen2.5-7B-ft":
        with open(f"data/{dataset}/eval_normal_7bft_sep_pred_use_best_hit.json","w") as f:
            json.dump(eval_res, f, indent=4)
    elif use_best_hit and model_name == "Qwen2.5-0.5B":
        with open(f"data/{dataset}/eval_normal_05b_sep_pred_use_best_hit.json","w") as f:
            json.dump(eval_res, f, indent=4)
    elif use_best_hit and model_name == "Qwen2.5-0.5B-ft":
        with open(f"data/{dataset}/eval_normal_05bft_sep_pred_use_best_hit.json","w") as f:
            json.dump(eval_res, f, indent=4)
    elif use_best_hit == False and model_name == "Qwen2.5-7B":
        with open(f"data/{dataset}/eval_normal_7b_sep_pred.json","w") as f:
            json.dump(eval_res, f, indent=4)
    elif use_best_hit == False and model_name == "Qwen2.5-7B-ft":
        with open(f"data/{dataset}/eval_normal_7bft_sep_pred.json","w") as f:
            json.dump(eval_res, f, indent=4)
    elif use_best_hit and model_name == "Qwen2.5-72B":
        with open(f"data/{dataset}/eval_normal_72b_sep_pred_use_best_hit.json","w") as f:
            json.dump(eval_res, f, indent=4)
    elif use_best_hit == False and model_name == "Qwen2.5-72B":
        with open(f"data/{dataset}/eval_normal_72b_sep_pred.json","w") as f:
            json.dump(eval_res, f, indent=4)
